      ...
      <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-footer about-btns">
            <a class="btn btn-success" title="MAppFx: Production Well Chloride - CNMI" href="https://ghs-cdn.uog.edu/wp-content/databases/MAppFx/saipan-chloride-app-develop-v2/index.html" target="_blank" rel="noreferrer noopener" role="button">MAppFx: Production Well Chloride - CNMI</a>
